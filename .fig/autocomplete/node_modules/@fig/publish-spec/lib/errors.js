...
(function (ValidationErrorEnum) {
    ...
    ValidationErrorEnum["noSpecPassed"] = "No spec passed. Neither `spec-path` or `binary-path` options were defined";
})(ValidationErrorEnum || (ValidationErrorEnum = {}));
export var GenericErrorEnum;
(function (GenericErrorEnum) {
    GenericErrorEnum["noSpecDataReceived"] = "No spec was received. The `spec-path` option was not defined and the binary did not send any completion spec to stdout";
    GenericErrorEnum["missingName"] = "Missing name. Either the `name` option or the `spec-path` option need to be passed to the program";
